...
const Blog = () => {
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '300px' }}>
    <div style={{ width: '48px', height: '48px', borderRadius: '50%', border: '4px solid #ede9f8', borderTopColor: '#22013a', animation: 'spin 0.8s linear infinite', marginBottom: '16px' }} />
    <p style={{ color: '#8e5203', fontWeight: '600' }}>Loading blogs...</p>
