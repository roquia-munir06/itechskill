...
//  const fmt = (d) => d
//   ? new Date(d).toLocaleDateString('en-PK', { day: '2-digit', month: 'long', year: 'numeric' })
//   : '—';
...
//                <td style={S.td}>
//   {inq.referral ? (
//     <span style={S.referralBadge}>
//       {inq.referral}
//     </span>
//   ) : (
//     <span style={{ color: '#d1c4e9', fontSize: '0.78rem' }}>—</span>
//   )}
// </td>
//                       <td style={S.td}>
...
//                   ['Date of Birth', selectedInquiry.dob
//   ? new Date(selectedInquiry.dob).toLocaleDateString('en-PK', {
//       day: '2-digit', month: 'long', year: 'numeric'
//     })
//   : '—'
// ],
// ['Age', selectedInquiry.dob
//   ? `${Math.floor((new Date() - new Date(selectedInquiry.dob)) / (365.25 * 24 * 60 * 60 * 1000))} years`
//   : '—'
// ],
...
//                   ['Referral', selectedInquiry.referral || '—'],
...
// td: { 
//   padding: '10px 12px', 
//   verticalAlign: 'middle'   // ← was 'top', middle looks cleaner
...
//   fontWeight: '700',
//   padding: '4px 10px',
//   borderRadius: '8px',        // ← rectangular now, pill looks odd on 2 lines
//   fontSize: '0.72rem',
//   border: '1px solid #fcd34d',
//   whiteSpace: 'normal',       // ← allow wrapping
//   wordBreak: 'break-all',     // ← break long URLs
//   display: 'inline-block',
//   maxWidth: '160px',          // ← limits width, forces 2-line wrap
//   lineHeight: '1.5',
// },
...
//   alignItems: 'center' 
// },
// waBtn:     { width: '28px', height: '28px', borderRadius: '6px', background: '#dcfce7', border: 'none', cursor: 'pointer', color: '#16a34a', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' },
// mailBtn:   { width: '28px', height: '28px', borderRadius: '6px', background: '#eff6ff', border: 'none', cursor: 'pointer', color: '#1d4ed8', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' },
// detailBtn: { width: '28px', height: '28px', borderRadius: '6px', background: '#faf5ff', border: 'none', cursor: 'pointer', color: '#7c3aed', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' },
// deleteBtn: { width: '28px', height: '28px', borderRadius: '6px', background: '#fff1f2', border: 'none', cursor: 'pointer', color: '#e11d48', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' },
          ...
          <div style={S.tableWrap}>
            {loading ? (
              ...
              <table style={S.table}>
                <thead>
                  <tr style={S.thead}>
                                     <th style={{ ...S.th, width: '200px' }}>Student</th>
<th style={{ ...S.th, width: '200px' }}>Program</th>
<th style={{ ...S.th, width: '130px' }}>Fee</th>
<th style={{ ...S.th, width: '150px' }}>Referral</th>
<th style={{ ...S.th, width: '110px' }}>Date</th>
<th style={{ ...S.th, width: '130px' }}>Status</th>
                ...
                <tbody>
                  {inquiries.map((inq, i) => (
                    ...
                    >
                      ...
                      <td style={S.td}>
  {inq.referral ? (
    <span style={S.referralBadge}>{inq.referral}</span>
  ) : (
    <span style={{ color: '#d1c4e9', fontSize: '0.78rem' }}>—</span>
  )}
</td>
...
const S = {
  ...
  tableWrap:    { flex: 1, background: '#fff', borderRadius: '12px', border: '1px solid #ede9f8', overflow: 'auto' },
  // table:        { width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' },
  table: { width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem', tableLayout: 'fixed' },
  thead:        { background: 'linear-gradient(135deg,#22013a,#7c1abd)' },
  th:           { padding: '12px 16px', color: '#fff', fontWeight: '700', textAlign: 'left', fontSize: '0.78rem', whiteSpace: 'nowrap' },
  tr:           { borderBottom: '1px solid #f3f4f6', transition: 'background 0.15s' },
  // td:           { padding: '12px 16px', verticalAlign: 'top' },
  td: { padding: '12px 16px', verticalAlign: 'top', overflow: 'hidden', wordBreak: 'break-word' },
  // studentName:  { fontWeight: '700', color: '#1a1228', fontSize: '0.88rem' },
  studentName: { fontWeight: '700', color: '#1a1228', fontSize: '0.88rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  program:     { fontWeight: '600', color: '#22013a', fontSize: '0.85rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  studentSub:   { fontSize: '0.75rem', color: '#9b8db0', marginTop: '2px' },
  // program:      { fontWeight: '600', color: '#22013a', fontSize: '0.85rem' },
  fee:          { fontSize: '0.82rem', fontWeight: '700', color: '#8e5203' },
  referralBadge: {
